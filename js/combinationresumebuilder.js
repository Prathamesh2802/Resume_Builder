window.onload = function()  {
    ...
    document.getElementById('name1').innerText = localStorage.getItem("combinationalname");
    document.getElementById('position1').innerText = localStorage.getItem("combinationalpos");
    document.getElementById('position_desc1').innerText = localStorage.getItem("combinationalpos_decs");
    document.getElementById('email1').innerText = localStorage.getItem("combinationalemail1");
    document.getElementById('phnumber2').innerText = localStorage.getItem("combinationalphnumber");
    document.getElementById('location2').innerText = localStorage.getItem("combinationallocation1");
    document.getElementById('linkedin2').innerText = localStorage.getItem("combinationallinkedin"); 
    document.getElementById('github2').innerText = localStorage.getItem("combinationalgithub"); 
    document.getElementById('workexperienceop1').innerText = localStorage.getItem("combinationalprevworkexp");
    document.getElementById('companyop1').innerText = localStorage.getItem("combinationalcompanyname");
    document.getElementById('fromto').innerText = localStorage.getItem("combinationalfromdate")+ localStorage.getItem("combinationaltodate");
    document.getElementById('ach1op').innerText = localStorage.getItem("combinationalachievement");
    document.getElementById('workexperienceop2').innerText = localStorage.getItem("combinationalprevworkexp1");
    document.getElementById('companyop2').innerText = localStorage.getItem("combinationalcompanyname1");
    document.getElementById('fromto1').innerText = localStorage.getItem("combinationalfromdate1")+ localStorage.getItem("combinationaltodate1");
    document.getElementById('ach2op').innerText = localStorage.getItem("combinationalachievement1");
    document.getElementById('degree1').innerText= localStorage.getItem("combinationalfield");
    document.getElementById('fromto3').innerText= localStorage.getItem("combinationalyear1"); 
    document.getElementById('collegename1').innerText= localStorage.getItem("combinationaleducation1");
    document.getElementById('degree2').innerText= localStorage.getItem("combinationalfield1"); 
    document.getElementById('fromto4').innerText= localStorage.getItem("combinationalyear2");
    document.getElementById('collegename2').innerText=  localStorage.getItem("combinationaleducation2");
    document.getElementById('degree3').innerText = localStorage.getItem("combinationalfield2");
    document.getElementById('fromto5').innerText =  localStorage.getItem("combinationalyear3");
    document.getElementById('collegename3').innerText =  localStorage.getItem("combinationaleducation3");
    document.getElementById('certificates1op').innerText = localStorage.getItem("combinationalcerticates1");
    document.getElementById('certificates2op').innerText = localStorage.getItem("combinationalcerticates2");
    document.getElementById('certificates3op').innerText = localStorage.getItem("combinationalcerticates3");
    document.getElementById('certificates4op').innerText = localStorage.getItem("combinationalcerticates4");
    document.getElementById('skill1op').innerText = localStorage.getItem("combinationalskill");
    document.getElementById('skill2op').innerText = localStorage.getItem("combinationalskill1");
    document.getElementById('skill3op').innerText = localStorage.getItem("combinationalskill2");
    document.getElementById('skill4op').innerText = localStorage.getItem("combinationalskill3");
    document.getElementById('skill5op').innerText = localStorage.getItem("combinationalskill4");
    document.getElementById('skill6op').innerText = localStorage.getItem("combinationalskill5");
    ...
    document.getElementById('lang1').innerText = localStorage.getItem("combinationallanguages");
    document.getElementById('lang2').innerText = localStorage.getItem("combinationallanguages1");
    document.getElementById('lang3').innerText = localStorage.getItem("combinationallanguages2");
    document.getElementById('stage1').innerText = localStorage.getItem("combinationalstageip");
    document.getElementById('stage2').innerText = localStorage.getItem("combinationalstage1ip");
    document.getElementById('stage3').innerText = localStorage.getItem("combinationalstage2ip");
    document.getElementById('awardop1').innerText = localStorage.getItem("combinationalaward");
    document.getElementById('awardop2').innerText = localStorage.getItem("combinationalaward1");
    document.getElementById('awardop3').innerText = localStorage.getItem("combinationalaward2");
    document.getElementById('awarddescop1').innerText = localStorage.getItem("combinationalawarddesc");
    document.getElementById('awarddescop2').innerText = localStorage.getItem("combinationalawarddesc1");
    document.getElementById('awarddescop3').innerText = localStorage.getItem("combinationalawarddesc2");
