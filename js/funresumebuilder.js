...
window.onload = function(){
    document.getElementById('name1').innerHTML = localStorage.getItem("funname");
    document.getElementById('summ1').innerHTML =localStorage.getItem("funsumm");
    document.getElementById('email1').innerHTML =localStorage.getItem("funemail1");
    document.getElementById('phnumber2').innerHTML =localStorage.getItem("funphnumber");
    document.getElementById('location2').innerHTML =localStorage.getItem("funlocation1");
    document.getElementById('linkedin2').innerHTML =localStorage.getItem("funlinkedin");
    document.getElementById('github2').innerHTML =localStorage.getItem("fungithub");
    document.getElementById('year11').innerHTML =localStorage.getItem("funyear1");
    document.getElementById('univ1').innerHTML =  localStorage.getItem("funeducation1");
    document.getElementById('score1').innerHTML = localStorage.getItem("funpercentage1");
    document.getElementById('year22').innerHTML = localStorage.getItem("funyear2");
    document.getElementById('univ2').innerHTML =   localStorage.getItem("funeducation2");
    document.getElementById('score2').innerHTML =  localStorage.getItem("funpercentage2");
    document.getElementById('year33').innerHTML =  localStorage.getItem("funyear3");
    document.getElementById('univ3').innerHTML =   localStorage.getItem("funeducation3");
    document.getElementById('score3').innerHTML =   localStorage.getItem("funpercentage3");
    document.getElementById('year44').innerHTML =  localStorage.getItem("funyear4");
    document.getElementById('score4').innerHTML =  localStorage.getItem("funpercentage4");
    document.getElementById('univ4').innerHTML =  localStorage.getItem("funeducation4");
    document.getElementById('cert1').innerHTML = localStorage.getItem("funcertificates1");
    document.getElementById('cert2').innerHTML = localStorage.getItem("funcertificates2");
    document.getElementById('cert3').innerHTML = localStorage.getItem("funcertificates3");
    document.getElementById('cert4').innerHTML = localStorage.getItem("funcertificates4");
    document.getElementById('interest1').innerHTML = localStorage.getItem("funinterest1"); 
    document.getElementById('softskills1').innerHTML = localStorage.getItem("funsoftskills1");
    document.getElementById('technicalskills1').innerHTML = localStorage.getItem("funtechnicalskills1");
    document.getElementById('lang1').innerHTML = localStorage.getItem("funlanguages");
