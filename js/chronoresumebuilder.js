...
document.getElementById('name1').innerHTML = localStorage.getItem("chrononame");
document.getElementById('position1').innerHTML = localStorage.getItem("chronopos");
document.getElementById('position_desc1').innerHTML = localStorage.getItem("chronopos_decs");
document.getElementById('email1').innerHTML = localStorage.getItem("chronoemail1");
document.getElementById('phnumber2').innerHTML = localStorage.getItem("chronophnumber");
document.getElementById('location2').innerHTML = localStorage.getItem("chronolocation1");
document.getElementById('linkedin2').innerHTML = localStorage.getItem("chronolinkedin"); 
document.getElementById('github2').innerHTML = localStorage.getItem("chronogithub"); 
document.getElementById('workexperienceop1').innerHTML = localStorage.getItem("chronoprevworkexp");
document.getElementById('companyop1').innerHTML = localStorage.getItem("chronocompanyname");
document.getElementById('fromto').innerHTML = localStorage.getItem("chronofromdate")+ localStorage.getItem("chronotodate");
document.getElementById('ach1op').innerHTML = localStorage.getItem("chronoachievement");
document.getElementById('workexperienceop2').innerHTML = localStorage.getItem("chronoprevworkexp1");
document.getElementById('companyop2').innerHTML = localStorage.getItem("chronocompanyname1");
document.getElementById('fromto1').innerHTML = localStorage.getItem("chronofromdate1")+ localStorage.getItem("chronotodate1");
document.getElementById('ach2op').innerHTML = localStorage.getItem("chronoachievement1");
document.getElementById('degree1').innerHTML= localStorage.getItem("chronofield");
document.getElementById('fromto3').innerHTML= localStorage.getItem("chronoyear1"); 
document.getElementById('collegename1').innerHTML= localStorage.getItem("chronoeducation1");
document.getElementById('degree2').innerHTML= localStorage.getItem("chronofield1"); 
document.getElementById('fromto4').innerHTML= localStorage.getItem("chronoyear2");
document.getElementById('collegename2').innerHTML=  localStorage.getItem("chronoeducation2");
document.getElementById('degree3').innerHTML = localStorage.getItem("chronofield2");
document.getElementById('fromto5').innerHTML =  localStorage.getItem("chronoyear3");
document.getElementById('collegename3').innerHTML =  localStorage.getItem("chronoeducation3");
document.getElementById('certificates1op').innerHTML = localStorage.getItem("chronocerticates1");
document.getElementById('certificates2op').innerHTML = localStorage.getItem("chronocerticates2");
document.getElementById('certificates3op').innerHTML = localStorage.getItem("chronocerticates3");
document.getElementById('certificates4op').innerHTML = localStorage.getItem("chronocerticates4");
document.getElementById('skill1op').innerHTML = localStorage.getItem("chronoskill");
document.getElementById('skill2op').innerHTML = localStorage.getItem("chronoskill1");
document.getElementById('skill3op').innerHTML = localStorage.getItem("chronoskill2");
document.getElementById('skill4op').innerHTML = localStorage.getItem("chronoskill3");
document.getElementById('skill5op').innerHTML = localStorage.getItem("chronoskill4");
document.getElementById('skill6op').innerHTML = localStorage.getItem("chronoskill5");
...
document.getElementById('lang1').innerHTML = localStorage.getItem("chronolanguages");
document.getElementById('lang2').innerHTML = localStorage.getItem("chronolanguages1");
document.getElementById('lang3').innerHTML = localStorage.getItem("chronolanguages2");
document.getElementById('stage1').innerHTML = localStorage.getItem("chronostageip");
document.getElementById('stage2').innerHTML = localStorage.getItem("chronostage1ip");
document.getElementById('stage3').innerHTML = localStorage.getItem("chronostage2ip");
